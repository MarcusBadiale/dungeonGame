...
public class SmallPotion extends Entity {

	private PotionType potionType;
	private double amount = 25;
	
	public SmallPotion(int x, int y, int width, int height, BufferedImage sprite , PotionType potionType) {
